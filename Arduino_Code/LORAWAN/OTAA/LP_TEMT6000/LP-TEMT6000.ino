...
static const u1_t PROGMEM DEVEUI[8] = { 0x04, 0x00, 0x01, 0x00, 0x00, 0x1A, 0xFF, 0x50 };
...
static const u1_t PROGMEM APPKEY[16] = { 0x4D, 0x35, 0x11, 0x6B, 0x8D, 0x36, 0xDA, 0x24, 0x97, 0x76, 0x0F, 0x09, 0xBB, 0x80, 0x6E, 0x1C };
